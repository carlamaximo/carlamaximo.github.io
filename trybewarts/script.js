...
function substituiFamilia() {
  ...
  // const familia = document.getElementById('frontend');
  const p4 = document.createElement('p');
  p4.innerText = `Família: ${familia}`;
  form.appendChild(p4);
}
...
function substituiForm(event) {
  const divPrimeirassa = document.getElementById('div-primeirassa');
  ...
  form.removeChild(divPrimeirassa);
}
